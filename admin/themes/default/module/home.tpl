            ...
            <div class="widget-box">
                ...
                <div  class="quick-actions_homepage">
                    <ul class="quick-actions">
                        <li> <a href="index.php?page=site_config"> <i class="icon-dashboard"></i> Website </a> </li>
                ...
                <div  class="quick-actions_homepage">
                    <ul class="quick-actions">
                        <li> <a href="index.php?page=user_config"> <i class="icon-user"></i> User </a> </li>
                        <li> <a href="index.php?page=customer_config"> <i class="icon-client"></i> Pelanggan </a> </li>
